...
require('koneksi.php');
	...
	echo '<div class="btn-group mr-2" role="group" > <a class="btn btn-primary" href="transaksisaldo.php">Tambah Saldo</a> </div>'; 
	...
	//echo '<div class="btn-group mr-2" role="group" > <a class="btn btn-secondary" href="peminjamlist.php">Daftar Peminjam</a> </div>'; 
	echo '
